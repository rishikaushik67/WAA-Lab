    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            while (mySession.hasMoreElements()) {
                ...
                List<String> myValue = (List<String>) session.getAttribute(mySessionVarName);
                out.println("Key = " + mySessionVarName + " First Name= " + myValue.get(0) + " Second Name = " + myValue.get(1) + "<br>" + "<br>");
            }
